const form = document.getElementById("inputnick");
// inputnick id를가진 태그 form에 담기
//<form id="inputnick" style="display: none;">
//      <input type="text" placeholder="Your NickName">
//</form>
console.log(form);

(input = form.querySelector("input")),
  // input 태그 중 첫번째 태그 반환 후 저장
  (greeting = document.querySelector(".removenick")),
  // removenick 태그 중 첫번째 클래스 태그 반환 후 저장
  (button = document.querySelector("button"));
// button 태그 중 첫번째 버튼 태그 반환 후 저장
console.log(button);
